...
class NNGenerator(object):
    ...
    def __init__(self, gentype, vocab, beamwidth, overgen,
        ...
        # hyperparameters - generator parameters the last set of parameters in config file for encdec
        ...
        self.params = []
        if self.gentype=='sclstm':  #idk where we find self.gentype but i thought we already took care of which model it is 
    ...
    def setWordVec(self,word2vec):  #calls setWordVec in generator
    ...
    def loadConverseParams(self):  #again calls loadConverseParams in generator
